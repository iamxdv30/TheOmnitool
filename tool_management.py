...
def initialize_tools():
    tools = [
        {"name": "Tax Calculator", "description": "Calculate taxes", "is_default": True},
        {"name": "Canada Tax Calculator", "description": "Calculate Canadian taxes", "is_default": False},
        {"name": "Unix Timestamp Converter", "description": "Convert Unix timestamps", "is_default": True},
        {"name": "Character Counter", "description": "Count characters in text", "is_default": True}
    ]
...
def list_all_tools():
    ...
    for tool in tools:
        print(f"Name: {tool.name}, Description: {tool.description}, Default: {tool.is_default}")
